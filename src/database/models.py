...
class Movie(Base):
    ...
    cast = relationship("Person", secondary=movie_cast_association, back_populates="acted_movies")  # Fixed: seconday -> secondary
    crew = relationship("Person", secondary=movie_crew_association, back_populates="crew_movies")  # Fixed: back_poplates -> back_populates
...
class Person(Base):
    ...
    # Relationships
    acted_movies = relationship("Movie", secondary=movie_cast_association, back_populates="cast")
    crew_movies = relationship("Movie", secondary=movie_crew_association, back_populates="crew")  # Fixed: back_populate -> back_populates
